...
=======================================================
  ...
  Mean detections / frame : 27.69
  Mean emitted / frame    : 27.61
  Unique IDs in CSV       : 96
  Fragmentation ratio     : 2.3x  (96 ids / 42 expected)
  Mean ID coverage        : 28.8% of frames
...
| Objective | Value |
|---|---|
| vial_count_error | 116.0 |
| per_id_coverage_loss | 0.0 frames/fly |
| short_track_count | 0 |
| per_frame_id_variance | 10.642 |
