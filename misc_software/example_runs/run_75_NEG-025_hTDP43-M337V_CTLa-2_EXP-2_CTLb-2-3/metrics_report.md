...
=======================================================
  ...
  Mean detections / frame : 18.0
  Mean emitted / frame    : 17.49
  Unique IDs in CSV       : 44
  Fragmentation ratio     : 1.6x  (44 ids / 28 expected)
  Mean ID coverage        : 39.8% of frames
  Suppressed tracks       : 4  (died before min_hits=3)
  Mean hits (suppressed)  : 0.5
...
| Objective | Value |
|---|---|
| vial_count_error | 16.0 |
| per_id_coverage_loss | 0.0 frames/fly |
| short_track_count | 0 |
| per_frame_id_variance | 4.979 |
