...
Rectangle {
    ...
    readonly property var rows: [
        ...
        ["drag",        "reposition any detection centroid"],
        ["C",           "confirm / lock focused track (green badge in TRACKS)"],
        ["Ctrl+⇧+C",   "enter/exit crop mode — clicks set segment start/end; type ID + Enter to bulk re-ID; Esc to cancel"],
        ["",            "VIEW"],
        ["Space",       "play/pause ±1s loop"],
        ["B",           "toggle bboxes"],
        ["mouse wheel", "zoom at cursor when fitted (zoom=1)"],
        ["Ctrl or Alt + wheel", "zoom at cursor when zoomed (trackpad pinch often uses Ctrl)"],
        ["two-finger drag / wheel", "pan when zoomed (over video or margins)"],
